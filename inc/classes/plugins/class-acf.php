			...
			acf_add_local_field_group(
				array(
					...
					'fields'                => array(
						...
						array(
							'key'               => 'field_9Jd8f0ecvNJUI',
							'label'             => esc_attr__( 'Url to Form', 'rgbcode-authform' ),
							'name'              => 'rgbc_authform_deposit_form_url',
							'type'              => 'url',
							'instructions'      => esc_html__( 'URL of the page where the form is located', 'rgbcode-authform' ),
							'required'          => 0,
							'conditional_logic' => 0,
							'wrapper'           => array(
								'width' => '',
...
//						),
						array(
							'key'               => 'field_62f2043dVGT54',
							'label'             => esc_attr__( 'Full Address', 'rgbcode-authform' ),
							'name'              => 'rgbc_authform_deposit_full_address',
							'type'              => 'group',
							'instructions'      => '',
							'required'          => 1,
							'conditional_logic' => 0,
							...
							'sub_fields'        => array(
								array(
									...
									'default_value'     => esc_attr__( 'Full Address', 'rgbcode-authform' ),
									'placeholder'       => '',
									'prepend'           => '',
									'append'            => '',
									'maxlength'         => 30,
								...
								array(
									...
									'default_value'     => esc_attr__( 'Please insert a valid full address', 'rgbcode-authform' ),
									'placeholder'       => '',
									'prepend'           => '',
									'append'            => '',
									'maxlength'         => '',
						...
						array(
							'key'               => 'field_62f20dcucdfe32',
							'label'             => esc_attr__( 'Text for button Address in not listed', 'rgbcode-authform' ),
							'name'              => 'rgbc_authform_btn_is_not_listed',
							'type'              => 'text',
							'instructions'      => '',
							'required'          => 1,
							'conditional_logic' => 0,
							...
							'default_value'     => esc_attr__( 'My address is not listed', 'rgbcode-authform' ),
							'placeholder'       => '',
							'prepend'           => '',
							'append'            => '',
							'maxlength'         => 30,
