...
define( 'RGBCODE_AUTHFORM_VERSION', '1.0.6' );
define( 'RGBCODE_AUTHFORM_IMAGES', RGBCODE_AUTHFORM_PLUGIN_URL . 'assets/images' );
define( 'RGBCODE_AUTHFORM_IMAGES_DIR', RGBCODE_AUTHFORM_PLUGIN_DIR . 'assets/images' );
